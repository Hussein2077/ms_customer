...
import 'package:ms_customer/minor_screens/visit_store.dart';
import 'package:ms_customer/minor_screens/full_screen_view.dart';
import 'package:ms_customer/models/product_model.dart';
                        ...
                        Stack(children: [
                          ...
                          ExpandableTheme(
                              data: const ExpandableThemeData(
                                  iconSize: 30, iconColor:  AppColor1.grey),
  ...
  return ExpandablePanel(
      header: const Padding(
        ...
        child: Text(
          'Reviews',
          style: TextStyle(
              color: AppColor1.grey, fontSize: 24, fontWeight: FontWeight.bold),
        ),
      ),
      collapsed: SizedBox(
        height: 230,

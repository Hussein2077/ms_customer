...
import 'package:ms_customer/view/screens/minor_screens/visit_store.dart';
import 'package:ms_customer/view/screens/minor_screens/full_screen_view.dart';
                        ...
                        Stack(children: [
                          ...
                          ExpandableTheme(
                              data: const ExpandableThemeData(
                                  iconSize: 30, iconColor:  AppColor.grey),
  ...
  return ExpandablePanel(
      header: const Padding(
        ...
        child: Text(
          'Reviews',
          style: TextStyle(
              color: AppColor.grey, fontSize: 24, fontWeight: FontWeight.bold),
        ),
      ),
      collapsed: SizedBox(
        height: 230,
